...
# transcript = pt.Transcript(name="transcript",length=transcript_length)
# transcript.add_gene(name="proteinP", start=30, stop=360,rbs_start=(30 - 15), rbs_stop=30, rbs_strength=1e7)
# transcript.add_weights(weights=test_transcript_weights)
# print("added weights")
# sim.register_transcript(transcript)
# print("registered transcript")
# sim.simulate(time_limit=100, time_step=1, output="test_counts.tsv")
#
